...
function _s_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Homepage Hero Sidebar', '_s' ),
...
function _s_scripts() {
	...
	wp_enqueue_script( 'instafeed-js', get_template_directory_uri() . '/js/instafeed.min.js', array(), '20160616', true );
...
/**
 * Add Advanced Custom Fields custom options page.
 */
